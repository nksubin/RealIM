...
@synthesize showUsername=_showUsername;
   ...
   if (self.showUsername)
    {
        ...
        NSLog(@"%@",self.data.userName);
        self.userName.textColor=[UIColor whiteColor];
        CGFloat userNameX = (type == BubbleTypeSomeoneElse) ? 2 : self.frame.size.width - 52;
        CGFloat userNameY = self.frame.size.height-40;
        
        self.userName.frame = CGRectMake(userNameX, userNameY, 50, 50);
